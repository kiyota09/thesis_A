      ...
      <div class="bg-white rounded-lg shadow-md border border-gray-200 p-6">
        ...
        <div class="space-y-3">
          ...
          <div class="pt-2 border-t border-gray-200">
            <p class="text-xs text-gray-500">Used: {{ props.leaveBalance.used }} / Total: {{ props.leaveBalance.total }}
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="space-y-3 max-h-64 overflow-y-auto">
          ...
          <div v-for="record in props.recentAttendance" :key="record.date"
            ...
            <div>
              ...
              <p class="text-sm text-gray-600">{{ record.clockIn }} - {{ record.clockOut || 'Not clocked out' }}</p>
            </div>
            <span :class="[
    ...
    <div class="bg-white rounded-lg shadow-md border border-gray-200 p-6">
      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        <div v-for="holiday in props.upcomingHolidays" :key="holiday.id"
          ...
          <span class="inline-block mt-2 px-2 py-1 bg-blue-200 text-blue-800 text-xs rounded font-medium">
            {{ holiday.type }}
          </span>
        </div>
      </div>

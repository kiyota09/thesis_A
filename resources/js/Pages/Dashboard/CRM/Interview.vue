            ...
            <div class="max-w-2xl mx-auto px-4 sm:px-6 py-6 space-y-8">
                ...
                <div v-else class="space-y-3">
                    <div v-for="applicant in applicants" :key="applicant.id"
                        ...
                        <div v-else class="px-4 pb-4 text-center text-[11px] text-slate-400 italic">View only · Contact CRM manager to manage this interview</div>
